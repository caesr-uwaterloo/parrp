 ...
 */
void compute_w_coefficients(int n, int a, int b, COMPLEX * W, int* omptr_bb_id_ptr)
{
	OMPTR_NEW_CONTEXT();
     ...
     if (b - a < 128) {
	  ...
	  int ab = (a + b) / 2;
	  OMPTR_BEFORE_TASK();
      #pragma omp task untied firstprivate(omptr_bb_id)
	  {
		OMPTR_TASK_START();
	  	compute_w_coefficients(n, a, ab, W, &omptr_bb_id);
		OMPTR_TASK_END();
	  }
	  OMPTR_AFTER_TASK();
	  OMPTR_BEFORE_TASK();
	  ...
	  {
		OMPTR_TASK_START();
	    compute_w_coefficients(n, ab + 1, b, W, &omptr_bb_id);
		OMPTR_TASK_END();
	  }
	  OMPTR_AFTER_TASK();
...
void unshuffle(int a, int b, COMPLEX * in, COMPLEX * out, int r, int m, int* omptr_bb_id_ptr)
{
	 OMPTR_NEW_CONTEXT();
     int i, j;
     int r4 = r & (~0x3);
     ...
     if (b - a < 16) {
	  ...
	  {
		OMPTR_TASK_START();
	  	unshuffle(a, ab, in, out, r, m, &omptr_bb_id);
		OMPTR_TASK_END();
	  }
	  OMPTR_AFTER_TASK();
	  OMPTR_BEFORE_TASK();
	  ...
	  {
		OMPTR_TASK_START();
	  	unshuffle(ab, b, in, out, r, m, &omptr_bb_id);
		OMPTR_TASK_END();
	  }
	  OMPTR_AFTER_TASK();
	  OMPTR_BEFORE_TASKWAIT();
...
void fft_twiddle_gen(int i, int i1, COMPLEX * in, COMPLEX * out, COMPLEX * W, int nW, int nWdn, int r, int m, int* omptr_bb_id_ptr)
{
	 OMPTR_NEW_CONTEXT();
     if (i == i1 - 1) {
		OMPTR_BEFORE_TASK();
...
void fft_twiddle_2(int a, int b, COMPLEX * in, COMPLEX * out, COMPLEX * W, int nW, int nWdn, int m, int* omptr_bb_id_ptr)
{
	 OMPTR_NEW_CONTEXT();
     int l1, i;
     COMPLEX *jp, *kp;
     ...
     if ((b - a) < 128) {
	  ...
	  {
		OMPTR_TASK_START();
	    fft_twiddle_2(a, ab, in, out, W, nW, nWdn, m, &omptr_bb_id);
		OMPTR_TASK_END();
	  }
	  OMPTR_AFTER_TASK();
	  OMPTR_BEFORE_TASK();
	  ...
	  {
		OMPTR_TASK_START();
	    fft_twiddle_2(ab, b, in, out, W, nW, nWdn, m, &omptr_bb_id);
		OMPTR_TASK_END();
	  }
	  OMPTR_AFTER_TASK();
	  OMPTR_BEFORE_TASKWAIT();
...
void fft_unshuffle_2(int a, int b, COMPLEX * in, COMPLEX * out, int m, int* omptr_bb_id_ptr)
{
	 OMPTR_NEW_CONTEXT();
     int i;
     const COMPLEX *ip;
     ...
     if ((b - a) < 128) {
	  ...
	  {
		OMPTR_TASK_START();
	  	fft_unshuffle_2(a, ab, in, out, m, &omptr_bb_id);
		OMPTR_TASK_END();
	  }
	  OMPTR_AFTER_TASK();
	  OMPTR_BEFORE_TASK();
	  ...
	  {
		OMPTR_TASK_START();
	  	fft_unshuffle_2(ab, b, in, out, m, &omptr_bb_id);
		OMPTR_TASK_END();
	  }
	  OMPTR_AFTER_TASK();
	  OMPTR_BEFORE_TASKWAIT();
...
void fft_twiddle_4(int a, int b, COMPLEX * in, COMPLEX * out, COMPLEX * W, int nW, int nWdn, int m, int* omptr_bb_id_ptr)
{
	 OMPTR_NEW_CONTEXT();
     int l1, i;
     COMPLEX *jp, *kp;
     ...
     if ((b - a) < 128) {
	  ...
	  {
		OMPTR_TASK_START();
	  	fft_twiddle_4(a, ab, in, out, W, nW, nWdn, m, &omptr_bb_id);
	  	OMPTR_TASK_END();
	  }
	  OMPTR_AFTER_TASK();
	  OMPTR_BEFORE_TASK();
	  ...
	  {
		OMPTR_TASK_START();
	  	fft_twiddle_4(ab, b, in, out, W, nW, nWdn, m, &omptr_bb_id);
		OMPTR_TASK_END();
	  }
	  OMPTR_AFTER_TASK(); 
	  OMPTR_BEFORE_TASKWAIT();
...
void fft_unshuffle_4(int a, int b, COMPLEX * in, COMPLEX * out, int m, int* omptr_bb_id_ptr)
{
	 OMPTR_NEW_CONTEXT();
     int i;
     const COMPLEX *ip;
     ...
     if ((b - a) < 128) {
	  ...
	  {
		OMPTR_TASK_START();
	  	fft_unshuffle_4(a, ab, in, out, m, &omptr_bb_id);
		OMPTR_TASK_END();
	  }
	  OMPTR_AFTER_TASK();
	  OMPTR_BEFORE_TASK();
	  ...
	  {
		OMPTR_TASK_START();
	  	fft_unshuffle_4(ab, b, in, out, m, &omptr_bb_id);
		OMPTR_TASK_END();
	  }
	  OMPTR_AFTER_TASK();
	  OMPTR_BEFORE_TASKWAIT();
...
void fft_twiddle_8(int a, int b, COMPLEX * in, COMPLEX * out, COMPLEX * W, int nW, int nWdn, int m, int* omptr_bb_id_ptr)
{
	 OMPTR_NEW_CONTEXT();
     int l1, i;
     COMPLEX *jp, *kp;
     ...
     if ((b - a) < 128) {
	  ...
	  {
		OMPTR_TASK_START();
	  	fft_twiddle_8(a, ab, in, out, W, nW, nWdn, m, &omptr_bb_id);
		OMPTR_TASK_END();
	  }
	  OMPTR_AFTER_TASK();
	  OMPTR_BEFORE_TASK();
	  ...
	  {
		OMPTR_TASK_START();
	  	fft_twiddle_8(ab, b, in, out, W, nW, nWdn, m, &omptr_bb_id);
		OMPTR_TASK_END();
	  }
	  OMPTR_AFTER_TASK();
	  OMPTR_BEFORE_TASKWAIT();
...
void fft_unshuffle_8(int a, int b, COMPLEX * in, COMPLEX * out, int m, int* omptr_bb_id_ptr)
{
	 OMPTR_NEW_CONTEXT();
     int i;
     const COMPLEX *ip;
     ...
     if ((b - a) < 128) {
	  ...
	  {
		OMPTR_TASK_START();
	  	fft_unshuffle_8(a, ab, in, out, m, &omptr_bb_id);
		OMPTR_TASK_END();
	  }
	  OMPTR_AFTER_TASK();
	  OMPTR_BEFORE_TASK();
	  ...
	  {
		OMPTR_TASK_START();
	  	fft_unshuffle_8(ab, b, in, out, m, &omptr_bb_id);
		OMPTR_TASK_END();
	  }
	  OMPTR_AFTER_TASK();
	  OMPTR_BEFORE_TASKWAIT();
...
void fft_twiddle_16(int a, int b, COMPLEX * in, COMPLEX * out, COMPLEX * W, int nW, int nWdn, int m, int* omptr_bb_id_ptr)
{
	 OMPTR_NEW_CONTEXT();
     int l1, i;
     COMPLEX *jp, *kp;
     ...
     if ((b - a) < 128) {
	  ...
	  {
		OMPTR_TASK_START();
	  	fft_twiddle_16(a, ab, in, out, W, nW, nWdn, m, &omptr_bb_id);
		OMPTR_TASK_END();
	  }
	  OMPTR_AFTER_TASK();
	  OMPTR_BEFORE_TASK();
	  ...
	  {
		OMPTR_TASK_START();
	  	fft_twiddle_16(ab, b, in, out, W, nW, nWdn, m, &omptr_bb_id);
		OMPTR_TASK_END();
	  }
	  OMPTR_AFTER_TASK();
	  OMPTR_BEFORE_TASKWAIT();
...
void fft_unshuffle_16(int a, int b, COMPLEX * in, COMPLEX * out, int m, int* omptr_bb_id_ptr)
{
	 OMPTR_NEW_CONTEXT();
     int i;
     const COMPLEX *ip;
     ...
     if ((b - a) < 128) {
	  ...
	  {
		OMPTR_TASK_START();
	  	fft_unshuffle_16(a, ab, in, out, m, &omptr_bb_id);
		OMPTR_TASK_END();
	  }
	  OMPTR_AFTER_TASK();
	  OMPTR_BEFORE_TASK();
	  ...
	  {
		OMPTR_TASK_START();
	  	fft_unshuffle_16(ab, b, in, out, m, &omptr_bb_id);
		OMPTR_TASK_END();
	  }
	  OMPTR_AFTER_TASK();
	  OMPTR_BEFORE_TASKWAIT();
...
void fft_twiddle_32(int a, int b, COMPLEX * in, COMPLEX * out, COMPLEX * W, int nW, int nWdn, int m, int* omptr_bb_id_ptr)
{
	 OMPTR_NEW_CONTEXT();
     int l1, i;
     COMPLEX *jp, *kp;
     ...
     if ((b - a) < 128) {
	  ...
	  {
		OMPTR_TASK_START();
	  	fft_twiddle_32(a, ab, in, out, W, nW, nWdn, m, &omptr_bb_id);
		OMPTR_TASK_END();
	  }
	  OMPTR_AFTER_TASK();
	  OMPTR_BEFORE_TASK();
	  ...
	  {
		OMPTR_TASK_START();
	  	fft_twiddle_32(ab, b, in, out, W, nW, nWdn, m, &omptr_bb_id);
		OMPTR_TASK_END();
	  }
	  OMPTR_AFTER_TASK();
	  OMPTR_BEFORE_TASKWAIT();
...
void fft_unshuffle_32(int a, int b, COMPLEX * in, COMPLEX * out, int m, int* omptr_bb_id_ptr)
{
	 OMPTR_NEW_CONTEXT();
     int i;
     const COMPLEX *ip;
     ...
     if ((b - a) < 128) {
	  ...
	  {
		OMPTR_TASK_START();
	  	fft_unshuffle_32(a, ab, in, out, m, &omptr_bb_id);
		OMPTR_TASK_END();
	  }
	  OMPTR_AFTER_TASK();
	  OMPTR_BEFORE_TASK();
	  ...
	  {
		OMPTR_TASK_START();
	  	fft_unshuffle_32(ab, b, in, out, m, &omptr_bb_id);
		OMPTR_TASK_END();
	  }
	  OMPTR_AFTER_TASK();
	  OMPTR_BEFORE_TASKWAIT();
 ...
 *
 */
void fft_aux(int n, COMPLEX * in, COMPLEX * out, int *factors, COMPLEX * W, int nW, int* omptr_bb_id_ptr)
{
	 OMPTR_NEW_CONTEXT();
     int r, m;
     int k;
     ...
     if (r < n) {
	  ...
	  if (r == 32) {
		OMPTR_BEFORE_TASK();
			   ...
			   {
				OMPTR_TASK_START();
	       fft_unshuffle_32(0, m, in, out, m, &omptr_bb_id);
		   OMPTR_TASK_END();
			   }
		OMPTR_AFTER_TASK();
	  } else if (r == 16) {
		OMPTR_BEFORE_TASK();
			   ...
			   {
				OMPTR_TASK_START();
	       fft_unshuffle_16(0, m, in, out, m, &omptr_bb_id);
		   OMPTR_TASK_END();
			   }
		OMPTR_AFTER_TASK();
	  } else if (r == 8) {
		OMPTR_BEFORE_TASK();
			   ...
			   {
				OMPTR_TASK_START();
	       fft_unshuffle_8(0, m, in, out, m, &omptr_bb_id);
		   OMPTR_TASK_END();
			   }
		OMPTR_AFTER_TASK();
	  } else if (r == 4) {
		OMPTR_BEFORE_TASK();
			   ...
			   {
				OMPTR_TASK_START();
	       fft_unshuffle_4(0, m, in, out, m, &omptr_bb_id);
		   OMPTR_TASK_END();
			   }
		OMPTR_AFTER_TASK();
	  } else if (r == 2) {
		OMPTR_BEFORE_TASK();
			   ...
			   {
				OMPTR_TASK_START();
	       fft_unshuffle_2(0, m, in, out, m, &omptr_bb_id);
		   OMPTR_TASK_END();
			   }
		OMPTR_AFTER_TASK();
	  } else {
	       unshuffle(0, m, in, out, r, m, &omptr_bb_id);
	  }
	  ...
	  for (k = 0; k < n; k += m) {
		   OMPTR_BEFORE_TASK();
			   ...
			   {
				OMPTR_TASK_START();
	       fft_aux(m, out + k, in + k, factors + 1, W, nW, &omptr_bb_id);
				OMPTR_TASK_END();
			   }
		   OMPTR_AFTER_TASK();
	  }
     ...
     if (r == 2) {
		OMPTR_BEFORE_TASK();
		  ...
		  {
			OMPTR_TASK_START();
	  fft_twiddle_2(0, m, in, out, W, nW, nW / n, m, &omptr_bb_id);
	  OMPTR_TASK_END();
		  }
		OMPTR_AFTER_TASK();
     } else if (r == 4) {
		OMPTR_BEFORE_TASK();
		  ...
		  {
			OMPTR_TASK_START();
	  fft_twiddle_4(0, m, in, out, W, nW, nW / n, m, &omptr_bb_id);
	  OMPTR_TASK_END();
		  }
		OMPTR_AFTER_TASK();
     } else if (r == 8) {
		OMPTR_BEFORE_TASK();
		  ...
		  {
			OMPTR_TASK_START();
	  fft_twiddle_8(0, m, in, out, W, nW, nW / n, m, &omptr_bb_id);
	  OMPTR_TASK_END();
		  }
		OMPTR_AFTER_TASK();
     } else if (r == 16) {
		OMPTR_BEFORE_TASK();
		  ...
		  {
			OMPTR_TASK_START();
	  fft_twiddle_16(0, m, in, out, W, nW, nW / n, m, &omptr_bb_id);
	  OMPTR_TASK_END();
		  }
		OMPTR_AFTER_TASK();
     } else if (r == 32) {
		OMPTR_BEFORE_TASK();
		  ...
		  {
			OMPTR_TASK_START();
	  fft_twiddle_32(0, m, in, out, W, nW, nW / n, m, &omptr_bb_id);
	  OMPTR_TASK_END();
		  }
		OMPTR_AFTER_TASK();
     } else {
		OMPTR_BEFORE_TASK();
		  ...
		  {
			OMPTR_TASK_START();
	  fft_twiddle_gen(0, m, in, out, W, nW, nW / n, r, m, &omptr_bb_id);
	  OMPTR_TASK_END();
		  }
		OMPTR_AFTER_TASK();
     }
...
void fft(int n, COMPLEX * in, COMPLEX * out)
{
	 ...
	 {
		OMPTR_TASK_START();
     	compute_w_coefficients(n, 0, n / 2, W, &omptr_bb_id);
		OMPTR_TASK_END();
	 }  // end task
	 	OMPTR_AFTER_TASK();

		// Add an explicit task wait to properly capture DAG structure
		OMPTR_BEFORE_TASKWAIT();
		#pragma omp taskwait
		OMPTR_AFTER_TASKWAIT();
		...
		*p++ = r;
		...
		{
			OMPTR_TASK_START();
			fft_aux(n, in, out, factors, W, n, &omptr_bb_id);
			OMPTR_TASK_END();
		}  // end task
	 	OMPTR_AFTER_TASK();
